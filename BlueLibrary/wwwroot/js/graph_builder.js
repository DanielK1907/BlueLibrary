$(document).ready(function () {
    ...
    } else if (window.location.pathname === "/Books/Index") {
        $.ajax({
            url: "/Books/BooksByAuthor"
        }).done(function (data) {
            const svg = d3.select('#container').append("svg").attr("viewBox", `0 0 1000 600`);
    ...
    } else if (window.location.pathname === "/Publishers/Index") {
        $.ajax({
            url: "/Publishers/PublisherGenres"
        }).done(function (data) {
            const svg = d3.select('#container').append("svg").attr("viewBox", `0 0 1000 600`);
            ...
            svg.append('text')
                ...
                .attr('transform', 'rotate(-90)')
                .attr('text-anchor', 'middle')
                .text('Max amount of genres in book')
